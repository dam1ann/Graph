...
$("#approve-matrix").click(function () {
	...
	var calculationResult = _graphCalculation2.default.calculate(matrix);
	var links = calculationResult[0];
	var sumWeight = calculationResult[1];

	(0, _view.createView)(links, 80, true, 2);
